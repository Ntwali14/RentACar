...
function handleSubmit() {
  ...
  const formElement = document.getElementById('returnForm') as HTMLFormElement
  ...
  router.post(route('admin.returnInspection.store', props.reservation.id), data, {
    onError: () => {
...
<template>
  ...
  <AdminLayout>
    <main class="flex-1 p-8 space-y-6">
      ...
      <form id="returnForm" class="space-y-6" @submit.prevent="handleSubmit">
        <!-- Reservation Info -->
